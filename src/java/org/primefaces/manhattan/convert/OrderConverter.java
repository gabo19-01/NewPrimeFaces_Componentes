 ...
 */
package org.primefaces.manhattan.convert;
...
import org.primefaces.manhattan.domain.Order;

@FacesConverter("org.primefaces.manhattan.converter.OrderConverter")
...
*/
    ...
    public String getAsString(FacesContext facesContext, UIComponent component,
        ...
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((TimelineEvent) value).getId());
        }
    }
}
